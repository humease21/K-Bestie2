...
const faqData = [
  ...
  },
  {
    ...
    answer: "아니요, 내친구 케이는 의료적 진단이나 전문적인 심리 상담을 대체하는 서비스가 아닙니다. 아이가 케이와 나눈 하루를 요약해, 부모님이 아이의 하루를 더 잘 이해하고 자연스럽게 대화를 시작하도록 돕는 '소통 도우미'입니다. 심각한 징후가 보일 경우 반드시 전문가의 도움을 받으시길 권장합니다."
  },
  {
    category: "아이 사용 경험",
  ...
  },
  {
    ...
    answer: "네, 하루 2회(각 5분) 대화를 권장합니다. 최소 2주간 꾸준히 대화해야 더 정확한 요약 리포트가 제공되기 시작합니다. 매일 꾸준히 할수록 아이의 하루를 더 잘 따라갈 수 있습니다."
  },
  {
    category: "부모 리포트",
  ...
  },
  {
    ...
    answer: "아이의 대화는 원문 그대로 저장하지 않으며, 케이가 요약한 리포트 형태로만 안전하게 관리됩니다. 어떤 경우에도 부모님의 동의 없이 제3자에게 제공되지 않습니다. 자세한 내용은 개인정보처리방침을 참고해 주세요."
  },
  {
    category: "보안 및 개인정보",
